import os
os.environ['CUDA_VISIBLE_DEVICES'] = '7'  # Set this before any torch import
...
with tqdm(total=1, desc="Loading model") as pbar:
    pipe = pipeline(MODEL_DIR, device=DEVICE)
    pbar.update(1)
...
with open(OUTPUT_FILE, 'w', encoding='utf-8') as f:
    f.write("# CogVLM Evaluation Results\n")
...
for sample in pbar:
    ...
    try:
        ...
        # Extract just the first line (remove any trailing text)
